...
describe("Database", function () {
  it("Can open and close cleanly", function (done) {
    var db = new Datastore(
      { filename: closeDb, autoload: true },
      function () {}
    );
  ...
  it("Can open multiple databases, and then close them again", function (done) {
    var multiOne = new Datastore(
      { filename: "workspace/multiOne.db", autoload: true },
      function () {}
    );
    var multiTwo = new Datastore(
      { filename: "workspace/multiTwo.db", autoload: true },
      function () {}
    );
    var multiThree = new Datastore(
      { filename: "workspace/multiThree.db", autoload: true },
      function () {}
    );
    var multiFour = new Datastore(
      { filename: "workspace/multiFour.db", autoload: true },
      function () {}
    );
    var multiFive = new Datastore(
      { filename: "workspace/multiFive.db", autoload: true },
      function () {}
    );
    var multiSix = new Datastore(
      { filename: "workspace/multiSix.db", autoload: true },
      function () {}
    );
    var multiSeven = new Datastore(
      { filename: "workspace/multiSeven.db", autoload: true },
      function () {}
    );
    var multiEight = new Datastore(
      { filename: "workspace/multiEight.db", autoload: true },
      function () {}
    );
    var multiNine = new Datastore(
      { filename: "workspace/multiNine.db", autoload: true },
      function () {}
    );
    var multiTen = new Datastore(
      { filename: "workspace/multiTen.db", autoload: true },
      function () {}
    );
